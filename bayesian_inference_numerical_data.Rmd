...
bayes_inference(y = weight, x = habit, data = nc_fullterm, 
                statistic = "mean", 
                type = "ht", alternative = "twosided", null = 0, 
                hypothesis_prior = c(0.25, 0.75), rscale = 1, 
                method = "theoretical", show_plot = FALSE)
```
...
bayes_inference(y = weight, x = habit, data = nc_fullterm, 
                statistic = "mean", 
                type = "ht", alternative = "twosided", null = 0, 
                hypothesis_prior = c(0.25, 0.75), rscale = sqrt(2)/2, 
                method = "theoretical", show_plot = FALSE)
```
...
500.5 * (((2.055^2)*(1000/1001))/1001)^1/2
```
(((2.055^2)*(1000/1001))/1001)^(1001/2)
